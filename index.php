			...
			<div class="row loginmargin">
				<div class="col-sm-6 col-sm-offset-3 loginblock">
					...
					<form method="post" action="">
						<input type="text" class="form-control login-form" name="user" value="<?php if(isset($_POST['user'])){echo $_POST['user'];}   ?>" placeholder="<?php if(isset($_POST['user'])) { echo $_POST['user']; }else{echo"Gebruikersnaam";}?>"/>
