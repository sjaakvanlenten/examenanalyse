									...
									<table class="table table-bordered table-hover">
										...
										<?php
												if($result != NULL){
														...
														<td >
															<div class="progress">
																<div class="progress-bar progress-bar-<?php if($result <= 50){echo "danger";} elseif($result <= 75){echo "warning";}else{echo "success";}?> progress-bar-striped" role="progressbar" style="width: <?php if(empty($result)){echo 0;}else {echo $result;}?>%">
																	<?php if(empty($result)){echo 0;}else {echo $result;}?>%
																</div>
															</div>
														</td>
														<?php
